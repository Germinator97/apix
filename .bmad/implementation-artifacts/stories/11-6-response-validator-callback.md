...
Some legacy backends return HTTP 200 even when the business operation failed, with the error encoded in the response body:

```json
{ "success": false, "error_code": "OUT_OF_STOCK", "message": "Article indisponible" }
```
