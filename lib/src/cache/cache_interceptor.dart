...
class CacheInterceptor extends Interceptor {
  ...
  /// was still written, so choosing `networkOnly` for personal data moved
  /// every response through a store nobody ever read from. The
...
extension CacheResponseExtension on Response<dynamic> {
  ...
  /// value's age changes what the user should do with it. On a stock level, a
  /// quota or a status, treat it as mandatory.
  ///
