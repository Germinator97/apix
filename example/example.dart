...
void main() async {
  ...
  final client = ApiClientFactory.create(
    ...
    retryConfig: const RetryConfig(
      ...
      // (e.g. a gateway 502/504 on an order) is never replayed into a
    ...
    cacheConfig: CacheConfig(
      ...
      // is also what must not leak — personal data, anything about an
  ...
  try {
    ...
    // whose age changes what the user should do — a stock level, a quota.
    ...
    final order = await client.postAndDecode(
      '/orders',
      {'quantity': 2},
      User.fromJson,
      options: Options(
    ...
    debugPrint('Order placed by: ${order.name}');
    ...
    switch (e.code) {
      case 'OUT_OF_STOCK':
        debugPrint('Article indisponible.');
